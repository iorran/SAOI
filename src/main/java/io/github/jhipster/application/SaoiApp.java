...
public class SaoiApp {

    private static final Logger log = LoggerFactory.getLogger(SaoiApp.class);

    private final Environment env;

    public SaoiApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(SaoiApp.class);
