...
describe('Service Tests', () => {
    ...
    describe('QuestionTemplate Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(QuestionTemplateService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/question-templates';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return QuestionTemplate', () => {

                let entity: QuestionTemplate;
                service.find(123).subscribe((_entity: QuestionTemplate) => {
                    entity = _entity;
                });
